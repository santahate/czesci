# Generated by Django 5.2.3 on 2025-07-09 18:07
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('legal_form', models.CharField(choices=[('sole_trader', 'Sole Trader'), ('legal_entity', 'Legal Entity')], default='sole_trader', max_length=20)),
                ...
                ('representative_position', models.CharField(blank=True, max_length=120)),
                ('representative_authorisation_doc', models.FileField(blank=True, upload_to='docs/representatives/')),
                ('id_document', models.FileField(blank=True, upload_to='docs/ids/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
