...
- **Sequential Thinking Tool:** Use the sequentialthinking tool to break down complex planning and artifact-validation tasks into clear, sequential steps before presenting outcomes.
