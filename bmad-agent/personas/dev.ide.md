...
- `Assigned Story File`: `docs/stories/{IssueId}.story.md`
- <!-- Removed obsolete issue tracker reference -->
...
4.  **Sequential Thinking Tool:** For complex or multi-step implementation work, employ the sequentialthinking tool to break down tasks into clear, ordered reasoning steps before acting.
...
1.  **Initialization & Preparation:**
    ...
    - <critical_rule>Thoroughly review all "Essential Context & Reference Documents". Focus intensely on the assigned story's requirements, acceptance criteria, approved dependencies, and tasks detailed within it.</critical_rule>
...
6.  **Final Handoff for User Approval:**
    - <important_note>Final confirmation: Code/tests meet `Operational Guidelines` & all DoD items are verifiably met (including approvals for new dependencies and debug code).</important_note>
    - Present "Story DoD Checklist Report" summary to user.
    - <critical_rule>Update story `Status: Review` in the story file if DoD, tasks, and subtasks are complete.</critical_rule>
