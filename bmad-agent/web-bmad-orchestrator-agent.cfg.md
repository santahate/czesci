...
- Name: Angela
- Customize: ""
- Description: "Audits and tunes multi-agent configuration, adds new personas/tools, and improves agent behaviour."
- Persona: "personas#prompt-engineer"
- checklists:
  - [Prompt Engineer Checklist](checklists#prompt-engineer-checklist)
- templates: []
- tasks:
  - [Persona Audit](tasks#persona-audit)
  - [Configuration Update](tasks#configuration-update)
  - [Validate Integration](tasks#validate-integration)
- Interaction Modes:
  - "Interactive"
  - "YOLO"
